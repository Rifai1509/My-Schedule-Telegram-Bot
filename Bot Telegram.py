...
def main():
    ...
    while True:
        all_updates=RifaiScheduleBot.get_updates(new_offset)
        ...
        if len(all_updates) > 0:
            for current_update in all_updates:
                ...
                if first_chat_text == 'Monday':
                    RifaiScheduleBot.send_message(first_chat_id,
                                                  '''
                ...
                RifaiScheduleBot.send_message(first_chat_id, 'Hi,This Bot is your schedule. Please type a day name you want to see your schedule ')
                new_offset = first_update_id +1
